...
class GuideTab extends ConsumerWidget {
              ...
              children: [
                ...
                if (isOfficial) ...[
                  ...
                  _buildGuideExpansionTile(
                    ...
                    content:
                        'As an Official, your alerts override all other reports and are highlighted in blue (Tier 1).\n\n'
                  ...
                  _buildGuideExpansionTile(
                    ...
                    content:
                        'You can delegate trust to reliable community members, empowering them to verify crowdsourced data.\n\n'
                  ...
                  _buildGuideExpansionTile(
                    ...
                    content:
                        'The Cloud Gateway bridges the offline mesh network with the central government database.\n\n'
                  ...
                  _buildGuideExpansionTile(
                    ...
                    content:
                        'Ensure your teams and citizens have access to maps even when cell towers are down.\n\n'
                  ...
                  _buildGuideExpansionTile(
                    ...
                    content:
                        'You are the bridge between disconnected neighborhoods.\n\n'
                  ...
                  _buildGuideExpansionTile(
                    ...
                    content:
                        'Help others get connected and stay informed.\n\n'
                  ...
                  _buildGuideExpansionTile(
                    ...
                    content:
                        'Your primary role is to filter noise and elevate accurate information.\n\n'
                  ...
                  _buildGuideExpansionTile(
                    ...
                    content:
                        'False reports can cause panic or misdirect resources.\n\n'
                  ...
                  _buildGuideExpansionTile(
                    ...
                    content:
                        'Good reports save lives. Follow these best practices:\n\n'
                  ...
                  _buildGuideExpansionTile(
                    ...
                    content:
                        'You can build your own localized web of trust.\n\n'
                  ...
                  _buildGuideExpansionTile(
                    ...
                    content:
                        'During a disaster, battery life is critical.\n\n'
                  ...
                  _buildGuideExpansionTile(
                    ...
                    content:
                        'If someone needs Floodio but has no internet, you can share the app directly:\n\n'
                ...
                _buildGuideExpansionTile(
                  ...
                  content:
                      'Floodio uses a "Store and Forward" mesh network to keep you connected without internet or cell towers.\n\n'
                ...
                _buildGuideExpansionTile(
                  ...
                  content:
                      'Standard maps go blank without internet. Floodio allows you to save maps directly to your phone and share them offline.\n\n'
                ...
                _buildGuideExpansionTile(
                  ...
                  content:
                      'It is important to use the right tool to manage reports:\n\n'
                ...
                _buildGuideExpansionTile(
                  ...
                  content:
                      'To prevent malicious actors from spoofing official alerts or impersonating others, Floodio uses Ed25519 cryptographic signatures.\n\n'
  ...
  Widget _buildRoleBanner(BuildContext context, bool isOfficial, bool isTier2) {
    ...
    if (isOfficial) {
      ...
      subtitle =
          'You have full administrative capabilities to broadcast critical alerts, manage volunteers, and bridge the mesh network to the cloud.';
      icon = Icons.security;
    } else if (isTier2) {
      ...
      subtitle =
          'You are a trusted community leader. Your role is to verify crowdsourced reports, debunk misinformation, and help distribute offline maps.';
      icon = Icons.admin_panel_settings;
    } else {
      ...
      title = 'Citizen Node';
      subtitle =
          'You are a vital part of the mesh network. Report local hazards, trust reliable neighbors, and keep Auto-Sync on to relay information.';
      icon = Icons.people;
    }
          ...
          children: [
            ...
            if (isOfficial) ...[
              _buildStep(
                1,
                'Enable Auto-Sync',
                'Tap the status chip (top right) and toggle "Mesh Auto-Sync" ON to connect with nearby devices and build the local mesh.',
              ),
              _buildStep(
                2,
                'Broadcast Alerts',
                'Tap the "+" button to send Official Alerts. Mark them as "Critical" for immediate evacuation notices. These appear in Blue (Tier 1).',
              ),
              _buildStep(
                3,
                'Promote Volunteers',
                'Find reliable users in the feed and tap "Make Volunteer" to grant them verification powers. Manage them in the Command Tab.',
              ),
              _buildStep(
                4,
                'Cloud Gateway',
                'When internet is available, go to the Command Tab and tap "Force Cloud Sync Now" to upload mesh data to the central database and download global updates.',
              ),
            ] else if (isTier2) ...[
              _buildStep(
                1,
                'Enable Auto-Sync',
                'Tap the status chip (top right) and toggle "Mesh Auto-Sync" ON to relay data between citizens and officials.',
              ),
              _buildStep(
                2,
                'Verify Reports',
                'Check Unverified (Grey) reports. If you physically confirm them, tap "Verify & Endorse" to upgrade them to Verified (Purple) for everyone.',
              ),
              _buildStep(
                3,
                'Debunk False Info',
                'If a report is definitively false, tap "Debunk" to permanently remove it from the entire mesh network.',
              ),
              _buildStep(
                4,
                'Share Maps',
                'Download offline maps (Map tab -> Download icon) and broadcast them via the Sync menu to users without internet.',
              ),
            ] else ...[
              _buildStep(
                1,
                'Enable Auto-Sync',
                'Tap the status chip (top right) and toggle "Mesh Auto-Sync" ON. Your phone will act as a secure relay for emergency data.',
              ),
              _buildStep(
                2,
                'Download a Map',
                'While you still have internet, tap the download icon on the Map tab to save your local area for offline use.',
              ),
              _buildStep(
                3,
                'Report Hazards',
                'Tap the "+" button to mark floods, roadblocks, or safe zones. Your reports will spread automatically to nearby phones.',
              ),
              _buildStep(
                4,
                'Trust Reliable Users',
                'Tap "Trust" on reports from people you know. Their future updates will be prioritized on your device (Green).',
              ),
            ],
          ],
        ),
  ...
  Widget _buildTrustTierInfo(BuildContext context, int tier) {
    ...
    switch (tier) {
      case 1:
        icon = Icons.verified;
        desc =
            'Reports from Government, NGOs, or Emergency Services. These are always prioritized and highlighted in blue.';
        break;
      case 2:
        icon = Icons.admin_panel_settings;
        desc =
            'Reports from vetted volunteers. These carry high weight and can be used to verify crowdsourced data.';
        break;
      case 3:
        icon = Icons.thumb_up;
        desc =
            'People you have personally marked as "Trusted" in your Profile. Their reports are prioritized on your device only.';
        break;
      case 4:
        icon = Icons.people;
        desc =
            'General public reports. These are unverified until endorsed by a Tier 1 or Tier 2 user.';
        break;
    }
  ...
  final List<Map<String, String>> _steps = [
    {
      ...
      'content':
          'Floodio is an offline-first disaster communication network. It keeps you connected when cell towers and internet fail.',
      'icon': '👋',
    },
    {
      'title': 'The Mesh Network',
      'content':
          'By turning on "Mesh Auto-Sync", your phone will automatically find nearby users via Bluetooth and securely exchange emergency data over Wi-Fi Direct. You become a vital link in the chain.',
      'icon': '📡',
    },
    {
      'title': 'Trust & Verification',
      'content':
          'To fight rumors, reports are color-coded:\n\n🔵 Official (Gov/NGO)\n🟣 Verified (Trusted Volunteers)\n🟢 Trusted (Your Contacts)\n⚪ Unverified (Public)',
      'icon': '🛡️',
    },
    {
      'title': 'Reporting Hazards',
      'content':
          'Tap the "+" button to report floods, draw safe zones, or mark blocked roads. Add photos and descriptions to help your community navigate safely.',
      'icon': '📍',
    },
    {
      'title': 'Offline Maps',
      'content':
          'Download maps while you have internet. If the network goes down, you can still navigate and even share your downloaded maps directly with other users offline.',
      'icon': '🗺️',
    },
    {
      'title': 'Share the App Offline',
      'content':
          'If someone needs Floodio but has no internet, tap the Share icon in the top right to send them the app directly via Bluetooth or Nearby Share.',
      'icon': '📲',
    },
  ];
