...
- [`supabase_flutter`](#supabase_flutter)
  ...
  - [Usage example](#usage-example)
    ...
    - [Database](#database)
    - [Realtime](#realtime)
      - [Realtime data as `Stream`](#realtime-data-as-stream)
  ...
  - [Deep links](#deep-links)
    - [Why do you need to setup deep links](#why-do-you-need-to-setup-deep-links)
    - [When do you need to setup deep links](#when-do-you-need-to-setup-deep-links)
    - [Dashboard Deep link config](#dashboard-deep-link-config)
    - [Flutter Deep link config](#flutter-deep-link-config)
    - [Platform specific config](#platform-specific-config)
  - [Custom LocalStorage](#custom-localstorage)
    - [Persisting the user session from supabase\_flutter v1](#persisting-the-user-session-from-supabase_flutter-v1)
  - [Logging](#logging)
    - [Listen to all Supabase logs](#listen-to-all-supabase-logs)
    - [Sub-package loggers](#sub-package-loggers)
- [Logging](#logging)
